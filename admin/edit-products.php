...
<head>
	...
	<title>Admin| Insert medicine</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Medicine Name</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Medicine Company</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Medicine Price Before Discount</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Medicine Price</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">medicine Description</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Medicine Shipping Charge</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Medicine Availability</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Medicine Image1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Medicine Image2</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Medicine Image3</label>
<div class="controls">
